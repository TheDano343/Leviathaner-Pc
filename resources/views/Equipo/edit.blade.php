...
<form action="{{route('equipo.update',['equipo'=>$equipo])}}" method="post">
        ...
        <input class="form-control" type="text" name="Nombre_producto" value="{{$equipo->Nombre_producto}}">
        </div>
        
        <div class="form-group">
        <label>Tipo de tarjeta grafica</label>
        <input class="form-control" type="text" name="Tipo_de_tarjeta_grafica" value="{{$equipo->Tipo_de_tarjeta_grafica}}">
        </div>
        ...
        <div class="form-group">
                ...
                <select class="form-control" name="procecadores_id">
                    ...
                    @if($procesador->idProcesador == $equipo->procecadores_id)
                        <option selected value="{{ $procesador->idProcesador  }}">{{ $procesador->Nombre_del_producto }}</option>
                        @else
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="gabinetes_id">
                    ...
                    @if($gabinete->idGabinetes == $equipo->gabinetes_id)
                        <option selected value="{{ $gabinete->idGabinetes }}">{{ $gabinete->Nombre_del_producto }}</option>
                    @else
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="pantallas_id">
                    ...
                    @if($pantalla->idPantallas == $equipo->pantallas_id)
                        <option selected value="{{ $pantalla->idPantallas  }}">{{ $pantalla->Nombre_del_producto }}</option>
                        @else
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="teclados_id">
                    ...
                    @if($teclado->idTeclado == $equipo->teclados_id)
                        <option selected value="{{ $teclado->idTeclado }}">{{ $teclado->Nombre_del_producto }}</option>
                        @else
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="mouse_id">
                    ...
                    @if($mouse->idMouse == $equipo->mouse_id)
                        <option selected value="{{ $mouse->idMouse }}">{{ $mouse->Nombre_del_producto }}</option>
                        @else
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="graficas_id">
                    ...
                    @if($grafica->idTarjetaGrafica == $equipo->graficas_id)
                        <option selected value="{{ $grafica->idTarjetaGrafica }}">{{ $grafica->Nombre_del_producto }}</option>
                        @else
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="madres_id">
                    ...
                    @if($madre->idTarjetas_Madre == $equipo->madres_id)
                        <option selected value="{{ $madre->idTarjetas_Madre }}">{{ $madre->Nombre_del_producto }}</option>
                        @else
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="refrigeracion_id">
                    ...
                    @if($refrigeracion->idSistema_refrigeracion == $equipo->refrigeracion_id)
                        <option selected value="{{ $refrigeracion->idSistema_refrigeracion }}">{{ $refrigeracion->Nombre_del_producto }}</option>
                        @else
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="alimentaciones_id">
                    ...
                    @if($alimentacion->idAlimentacion == $equipo->alimentaciones_id)
                        <option selected value="{{ $alimentacion->idAlimentacion }}">{{ $alimentacion->Nombre_producto }}</option>
                        @else
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="categorias_id">
                    <option value="">Selecciona una CPU(Categoria)</option>
                    @foreach($categorium as $categorium)
                    @if($categorium->idCategoria  == $equipo->categorias_id )
                        <option selected value="{{ $categorium->idCategoria }}">{{ $categorium->Nombre }}</option>
                        @else
